...
// updating a game
var onGetUpdate = function onGetUpdate(gameData) {
  api.gameUpdate(gameData).then(ui.gameUpdateSuccess).then(function () {
    return onGetAllScores();
  }).then(function () {
    return onMyAllScores();
  }).catch(ui.gameUpdateFailure);
};
// getting all public high scores
var onGetAllScores = function onGetAllScores() {
  api.getAllScores().then(ui.getAllScoresSuccess).catch(ui.getAllScoresFailure);
};

// getting all scores that belongs to user
var onMyAllScores = function onMyAllScores() {
  api.getMyScores().then(ui.getMyScoresSuccess).catch(ui.getMyScoresFailure);
};

module.exports = {
  onGetAllScores: onGetAllScores,
  onMyAllScores: onMyAllScores,
...
module.exports = __webpack_require__.p + "a92390fe4a418dae261635214f12c7ae.png";

/***/ }),
/* 6 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "5ba2b760f6fb2e172af20980cdd00f91.png";

/***/ }),
/* 7 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "24143dfe7040777845d7396e9d623859.png";

/***/ }),
/* 8 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "8cbc6991b4da2b5382db667c1decb6ae.png";

/***/ }),
/* 9 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "44b707f5354c9ae53d0ae5833eba1ebe.png";
...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://capstone-game.herokuapp.com',
...
var getAllScores = function getAllScores(data) {
  return $.ajax({
...
var getMyScores = function getMyScores() {
  return $.ajax({
...
var showAllScoresTemplate = __webpack_require__(24);

var showMyScoresTemplate = __webpack_require__(41);

// gamelogic file
// const game = require('../gamelogic')

var getAllScoresSuccess = function getAllScoresSuccess(data) {
  // store.games = data.games
  var showAllScoresHtml = showAllScoresTemplate({
...
var getAllScoresFailure = function getAllScoresFailure() {
  $('#message').html('<div class="alert alert-danger" role="alert">Public scores are not available at the momnent!</div>');
  $('#message').css('text-align', 'center');
};

var getMyScoresSuccess = function getMyScoresSuccess(data) {
  // store.games = data.user.games
  var showMyScoresHtml = showMyScoresTemplate({
...
var getStartFailure = function getStartFailure() {
...
var gameUpdateSuccess = function gameUpdateSuccess() {
...
module.exports = {
  getAllScoresSuccess: getAllScoresSuccess,
  getAllScoresFailure: getAllScoresFailure,
  getMyScoresSuccess: getMyScoresSuccess,
  getMyScoresFailure: getMyScoresFailure,
  getStartSuccess: getStartSuccess,
  getStartFailure: getStartFailure,
...
var gameUpdateEvents = __webpack_require__(4);

// require all pictures
var alien1 = __webpack_require__(5);
// const alien2 = require('../../img/alien2.png')
var mike = __webpack_require__(6);
var hero1 = __webpack_require__(7);
// const hero2 = require('../../img/hero2.png')
var blast = __webpack_require__(8);
var explosion1 = __webpack_require__(9);
...
var handleInput = function handleInput() {
  ...
  if (input.isDown('f') && Date.now() - lastFire > 100) {
    var bulletPosX = posX + heroWidth / 2;
    var bulletPosY = posY;
...
var Explosion = function Explosion(x, y, index) {
  this.x = x;
  this.y = y;

  this.draw = function () {
    var explosionLook = new Image();
...
var enemies = function enemies() {
  timeOfGame += 0.015;
  if (Math.random() < 1 - Math.pow(0.993, timeOfGame)) {
    var enemyX = Math.random() * canvas.width;
...
var updateEntities = function updateEntities() {
  ...
  for (var _i = 0; _i < enemy.length; _i++) {
    enemy[_i].updatePos();
...
var collides = function collides(r1, r2) {
...
var gameEvents = __webpack_require__(43);
var gameUpdateEvents = __webpack_require__(4);
...
$('.pause_div').hide();
$(function () {
  var picLoader = __webpack_require__(44);
  var mike = __webpack_require__(6);
  var alien1 = __webpack_require__(5);
  var hero1 = __webpack_require__(7);
  var blast = __webpack_require__(8);
  ...
  picLoader.load([mike, alien1, hero1, blast, explosion1]);
...
var getFormFields = __webpack_require__(20);
...
var onAutoSignIn = function onAutoSignIn(data) {
  api.signIn(data).then(ui.signInSuccess).then(function () {
    return gameUpdateEvents.onGetAllScores();
  }).then(function () {
    return gameUpdateEvents.onMyAllScores();
...
var addNestedValue = __webpack_require__(21);
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "        <li>\n          <div class=\"col-xs-12\">"
    + container.escapeExpression(container.lambda(((stack1 = blockParams[0][0]) != null ? stack1.score : stack1), depth0))
    + "</div>\n        </li>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;
...
// starting a game
var onGetStart = function onGetStart() {
  api.getStart().then(ui.getStartSuccess).then(function () {
    return game.start();
...
var onReady = function onReady(func) {
...
module.exports = __webpack_require__.p + "373bd7e72bf5ea2b547cd31cd9c7a620.jpg";
...
module.exports = __webpack_require__.p + "348447e705580421dd11f2cfac0b6874.png";

/***/ }),
/* 58 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "dd6ea2c8ff241def23a0ad7296993dd5.png";

/***/ }),
/* 59 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "43c492e8384b89b542bf820d4fc96666.png";
